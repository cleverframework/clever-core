...
class ExpressEngine {
  ...
  initApp() {
    ...
    var config = this.app.config = this.clever.config.clean;
  ...
  beginBootstrap(cleverCoreInstance, database) {
    ...
    var config = cleverCoreInstance.config.clean;
...
function createEngine(cleverCoreInstance) {
  cleverCoreInstance.prototype.serveEngine = new ExpressEngine();
}
